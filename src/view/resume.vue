  ...
  <div class="resume">
    ...
    <div class="section technology">
      ...
      <ul>
        ...
        <li>
          <h2>3、 UI组件库</h2>
          <p>熟悉elementUI、ant Design、mint-ui、Ant Design Mobile、jQueryUI等UI组件库，有UI框架开发经验,能根据业务需求，封装高复用、可维护性好的前端基础组件。</p>
    ...
    <div class="section projects">
      ...
      <h2>一、芮想信息科技有限公司（2018/4至今）</h2>
      <p><strong>工作描述：</strong>在职期间主要负责快乐菜场、数据开放平台等项目的功能开发、组件开发及项目优化工作。项目涉及到权限控制、路由、状态管理、组件库、以及移动端项目与原生的交互等，项目主要框架为vue</p>
      ...
      <h2>二、浙江小赢卡乐信息技术有限公司（2017/9-2018/3）</h2>
      ...
      <h2>三、杭州天阙科技有限公司（2015/7-2017/8）</h2>
      ...
      <p><strong>项目地址：</strong><a target="_blank" href="http://www.zhangxiaode.com/changde/">www.zhangxiaode.com/changde/</a></p>
      <h2>四、个人项目</h2>
      <p>1、亢亢点单</p>
...
<style lang="less">
.resume{
  font-size:0.28rem;font-weight:normal;color:#101010;word-break:break-all;
  height:100%;overflow-x:hidden;overflow-y:auto;background:#fff;
  a{
  ...
  p{
    font-size:0.3rem;line-height:2;padding-bottom:0.2rem;text-indent:2em;
  }
  .profile{
    .photo{
    ...
    .career{
      font-size:0.24rem;text-align:center;color:#4c8cd6;
      line-height:1.5;
    }
    .info{
      width:6rem;margin:0.3rem auto 0.3rem;
      th,td{
        height:0.4rem;font-size:0.28rem;
      }
      th{
        width:2rem;padding-right:0.2rem;
        text-align:right;
      }
    }
  }
  ...
  .projects{
    h2:not(.title){
      font-size:0.34rem;text-align:left;line-height:2;
    }
  }
}
</style>
